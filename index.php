            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex flex-row justify-content-between">
                  ...
                  <p class="text-muted mb-1">Cloths status</p>
                </div>
                <div class="row">
                  <div class="col-12">
                      ...
                      ?>
                          ...
                          <div class="preview-item border-bottom">
                            ...
                            <div class="preview-item-content d-sm-flex flex-grow">
                              <div class="flex-grow">
                                <h6 class="preview-subject"><?php echo $row['customer_name'] ?></h6>
                                <!-- <p class="text-muted mb-0">Broadcast web app mockup</p> -->
                              </div>
                              <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                <p class="text-muted"><?php echo $row['cloth_count'] ?> Cloths</p>
                                <p class="text-muted mb-0"><?php echo $row['total_income'] ?> Rs </p>
                              </div>
                            </div>
                          </div>
